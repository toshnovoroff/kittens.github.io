...
const firstthing = document.querySelector('.herothing')
const secondthing = document.querySelector('.second-thing')
const firstbut = document.querySelector('.thing-arrow')
const secondbut = document.querySelector('.second-arrow')
const nextfirstbut = document.querySelector('.next-thing-arrow')
const nextsecondbut = document.querySelector('.next-second-arrow')

firstbut.addEventListener('click', () => {
  secondthing.style.display = 'flex';
  firstthing.style.display = 'none';
})

secondbut.addEventListener('click', () => {
  firstthing.style.display = 'flex';
  secondthing.style.display = 'none';
})


nextfirstbut.addEventListener('click', () => {
  secondthing.style.display = 'flex';
  firstthing.style.display = 'none';
})

nextsecondbut.addEventListener('click', () => {
  firstthing.style.display = 'flex';
  secondthing.style.display = 'none';
})
